    ...
    <section class="min-height-full relative">
        ...
        <div class="w-full flex justify-center">
            <form class="container border-show rounded-lg p-4 m-20 flex flex-col items-center w-2/5" method="post" enctype="multipart/form-data">
                ...
                <input class="button1 w-28 rounded-lg py-1 mt-10 font-bold" type="submit" value="Update" name="admin-myaccount-submit">
                <a class="mt-4 underline capitalize link" href="admin-update-mypassword.php">change password</a>
            </form>
        </div>
    </section>
